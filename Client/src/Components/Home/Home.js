...
import style from '../Assets/food-delivery-banner.png'
import img from '../Assets/5104.jpg'
import img1 from '../Assets/mixed-organic-berries-royalty-free-image-1708365586.jpg'
import img2 from '../Assets/Top-10-Crazy-and-Unusual-Square-Foods-7-510x541.webp'
import img3 from '../Assets/2158.jpg'
import img4 from '../Assets/89597.jpg'
import img5 from '../Assets/4757.jpg'
        ...
        <main>
            ...
            <section className="home" id="home">
              <div className="home-container body-container body-grid">
                <div className="home-data">
                  <h1 className="home-title"><span className="letter">S</span>ingleSpot</h1>
                  <h2 className="home-subtitle" style={{color:'white'}}>Imagine being <br />able to enjoy <br /> the finest pastries.</h2>
                  <div className="btn-menu">
                  <Link to='/Products'><a href="#" className="button btn-menu">View Menu</a></Link>
                  </div>
                </div>
                {/* <img src="" alt="home food picture" class="home-img"> */}
              </div>
            </section></div>
          {/* Menu */}
          <section className="menu section body-container" id="menu">
            <span className="subtitle"><span className="letter">S</span>pecial</span>
            <h2 className="title">Special of the week</h2>
            <div className="menu-container body-grid">
              <div className="menu-content">
                <img src={img3} alt="item one" className="menu-img1" />
                <h3 className="menu-name">Special Pizza</h3>
                <span className="menu-detail">Spicy</span>
                <span className="menu-preci">$3.50<span>
                    <a href="#" className="button menu-button"><i className="bx bx-cart" /></a>
                  </span></span></div>
              <div className="menu-content">
                <img src={img4} alt="item two" className="menu-img img-B" />
                <h3 className="menu-name">Chocolate Burger</h3>
                <span className="menu-detail">Special Birthday</span>
                <span className="menu-preci">$25.00<span>
                    <a href="#" className="button menu-button"><i className="bx bx-cart" /></a>
                  </span></span></div>
              <div className="menu-content">
                <img src={img5} alt="Imagen de Génesis Gabriella en Pixabay " className="menu-img img-B" />
                <h3 className="menu-name">Cappuccino</h3>
                <span className="menu-detail">Cappuccino + Cake</span>
                <span className="menu-preci">$2.00<span>
                    <a href="#" className="button menu-button"><i className="bx bx-cart" /></a>
                  </span></span></div>
            </div>
          </section>
          ...
          <div className="second">
            <section className="services section body-container" id="services">
              <span className="subtitle"><span className="letter">O</span>ffering</span>
          ...
          {/* App */}
          <section className="app section body-container">
            <div className="app-container body-grid">
              <div className="app-data">
                <span className="subtitle app-initial"><span className="letter">A</span>pp</span>
                <h2 className="title app-initial">App is available</h2>
                <p className="app-description">Find our application and download it, you can make reservations, food orders, see your deliveries on the way and much more.</p>
                <div className="app-stores">
                  <a href="#"><img src={img1} style={{height: '126px'}} alt="" className="app-store" /></a>
                  <a href="#"><img src={img2} alt="" className="app-store" /></a>
                </div>
              </div>
              <img src={style}  style={{height: '360px'}} alt="" className="app-img"></img>
            </div>
          </section>
          {/* About */}
          <div className="third">
            <section className="about section body-container" id="about">
              <div className="about-container body-grid">
                <div className="about-data">
                  <span className="subtitle about-initial"><span className="letter">A</span>bout us</span>
                  <h2 className="title about-initial">The best classic <br /> treats.</h2>
                  <p className="about-description">Our classic treats are made daily by in-house bakers, using the freshest &amp; finest ingredients, with excellent customer service and at the best price, visit us.</p>
                  <a href="#" className="button">Explore history</a>
                </div>
                <img src={img} alt="Imagen de yadetzy0 en Pixabay " className="about-img" />
              </div>
            </section>
          </div>
          {/* Contact */}
          <section className="contact section body-container" id="contact">
            <div className="contact-container body-grid">
              <div className="contact-data">
                <span className="subtitle contact-initial"><span className="letter">L</span>et's talk</span>
                <h2 className="title contact-initial">Contact us</h2>
                <p className="contact-description">Would you like to place a Custom Order or have feedback about our products or service? Please contact us.</p>
              </div>
